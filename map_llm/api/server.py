...
Endpoints:
  ...
  GET  /suggest-types   — LLM maps intent → place type shortlist
...
class LatencyMiddleware(BaseHTTPMiddleware):
    ...
    where tail latency governs user experience (Jeff Dean, "The Tail at Scale," 2013).
    """
...
def suggest_types(intent: str):
    """
    Map a free-text intent to a shortlist of Google Places API types.
...
def recommend(req: RecommendRequest):
    ...
    # prediction logging is the only way to detect silent quality degradation.
    logger.info(
